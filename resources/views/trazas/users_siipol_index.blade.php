...
@section('content')
    <section class="section">
        <div class="section-header">
            <h3 class="page__heading"><b>Trazas de Usuarios SIIPOL</b></h3>
        </div>
                ...
                <div class="col-lg-12">
                                    ...
                                    <table class="table table-striped mt-2 display dataTable table-hover">
                                        ...
                                        <tbody>
                                            ...
                                            <tr role="row" class="odd">
                                                ...
                                                <td class="sorting_1">{{$user->valores_modificados}}</td>
                    ...
                    <div class="modal fade" id="filtrar" tabindex="-1" aria-labelledby="filtro" aria-hidden="true">
                        ...
                        <div class="modal-content">
                            ...
                            {!! Form::open(array('route' => 'traza_user_siipol.index','method' => 'GET')) !!}
