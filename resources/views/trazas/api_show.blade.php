...
@section('content')
    <section class="section">
        <div class="section-header">
            <h3 class="page__heading"><b>Detallado de Trazas de API</b></h3>
        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-xs-3 col-sm-3 col-md-3">
                                <div class="form-group">
                                    ...
                                    {!! Form::text('fecha', $apis->usuario, array('class' => 'form-control', 'readonly')) !!}
                                </div>
                            </div>
                            <div class="col-xs-3 col-sm-3 col-md-3">
                                <div class="form-group">
                                    <label for="email">Ente (Ingresado por el Usuario)</label>
                                    {!! Form::text('fecha', $apis->ente, array('class' => 'form-control', 'readonly')) !!}
                                </div>
                            </div>
                            <div class="col-xs-3 col-sm-3 col-md-3">
                                <div class="form-group">
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-4">
                                <div class="form-group">
                                    ...
                                    {!! Form::text('fecha', $apis->organismo, array('class' => 'form-control', 'readonly')) !!}
                                </div>
                            </div>
                            <div class="col-xs-12 col-sm-12 col-md-4">
                                <div class="form-group">
                                    <label for="email">Dependencia</label>
                                    {!! Form::text('fecha', $apis->dependencia, array('class' => 'form-control', 'readonly')) !!}
                                </div>
                            </div>
                            <div class="col-xs-12 col-sm-12 col-md-4">
                                <div class="form-group">
                                    <label for="email">Ministerio</label>
                                    {!! Form::text('fecha', $apis->ministerio, array('class' => 'form-control', 'readonly')) !!}
                                </div>
                            </div> 
                        </div>
